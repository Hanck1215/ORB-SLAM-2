...
class KeyPointExtractor {
    public:
        ...
        */
        KeyPointExtractor(int nLevels, float defaultGridSize, int paddingPixels, int nKeyPoints, int maxTh, int minTh, int patchSize);
        ~KeyPointExtractor() {};
    ...
    private:
        int nLevels, paddingPixels, nKeyPoints, maxTh, minTh, patchSize;
