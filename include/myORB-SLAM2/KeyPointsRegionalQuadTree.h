...
class KeyPointsRegionalQuadTreeNode {
    public:
        ...
        int xmin, ymin, xmax, ymax; // 該節點在影像中的框框位置
...
class KeyPointsRegionalQuadTree {
    public:
        ...
        KeyPointsRegionalQuadTree(int width, int height, const vector<KeyPoint> &vKeyPoints);
        ...
        @param[in] node 指定要分裂的節點*/
        void divide(KeyPointsRegionalQuadTreeNode &node);
};
